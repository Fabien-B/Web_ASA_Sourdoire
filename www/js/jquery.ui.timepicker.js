...
(function ($) {
    ...
    function Timepicker() {
        ...
        this.regional[''] = { // Default regional settings
            hourText: 'Heures',           // Display text for hours section
            minuteText: 'Minutes',       // Display text for minutes link
            amPmText: ['AM', 'PM'],     // Display text for AM PM
            closeButtonText: 'Fermer',        // Text for the confirmation button (ok button)
            nowButtonText: 'Maintenant',           // Text for the now button
            deselectButtonText: 'Désélectionner'  // Text for the deselect button
        };
