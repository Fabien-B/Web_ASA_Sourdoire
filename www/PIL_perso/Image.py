...
from PIL_perso import VERSION, PILLOW_VERSION, _plugins
...
try:
    ...
    from PIL_perso import _imaging as core
...
from PIL_perso import ImageMode
from PIL_perso._binary import i8
from PIL_perso._util import isPath
from PIL_perso._util import isStringType
from PIL_perso._util import deferred_error
...
def preinit():
    ...
    try:
        from PIL_perso import BmpImagePlugin
    except ImportError:
        pass
    try:
        from PIL_perso import GifImagePlugin
    except ImportError:
        pass
    try:
        from PIL_perso import JpegImagePlugin
    except ImportError:
        pass
    try:
        from PIL_perso import PpmImagePlugin
    except ImportError:
        pass
    try:
        from PIL_perso import PngImagePlugin
    except ImportError:
        pass
#   try:
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def _new(self, im):
        ...
        if im.mode == "P" and not new.palette:
            from PIL_perso import ImagePalette
    ...
    def load(self):
        ...
        if self.im:
            if HAS_CFFI and USE_CFFI_ACCESS:
                ...
                from PIL_perso import PyAccess
    ...
    def offset(self, xoffset, yoffset=None):
        ...
        from PIL_perso import ImageChops
    ...
    def paste(self, im, box=None, mask=None):
        ...
        if isStringType(im):
            from PIL_perso import ImageColor
...
def _showxv(image, title=None, **options):
    from PIL_perso import ImageShow
